...
- 알림터 Mobile 프로젝트 카드와 Velog 구현 기록 링크 추가
- Ai응급맘 프로젝트 카드와 Velog 구현 기록 링크 추가
- 프로젝트 카드가 동일한 너비로 배치되도록 레이아웃 정렬
...
| Stats | 모바일 경력, 실전 프로젝트 경험 |
| Featured | 식수대장 서비스 구조와 아키텍처 다이어그램 |
