...
<<<<<<< HEAD
- 실제 프로젝트 스크린샷이 포함된 비대칭 프로젝트 카드, 중앙형 경력 타임라인, AI 역량, Contact 섹션 구성
...
| Projects | 뚝딱위치, 풀고켜고, 패스박스, 응급맘, BlogDraftAI, aiFallDownDetector, 단어팡 스크린샷 카드 |
