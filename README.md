...
핵심 메시지: **말 대신, 운영 중인 서비스로 증명합니다.**

## 작업 완료 내용

- GitHub Pages 배포용 React + TypeScript + Vite 프로젝트 구성
- TailwindCSS 기반의 절제된 엔지니어링 문서 톤 디자인 적용
- 이력서 내용을 바탕으로 프로필, 경력, 프로젝트, AI 역량 콘텐츠 정리
- 식수대장 B2B SaaS를 대표 서비스로 배치
- 주도 개발 범위를 보여주는 아키텍처 다이어그램 구현
- 경력 타임라인, 프로젝트 카드, AI 역량, Contact 섹션 구성
...
| Stats | 모바일 경력, 직접 구축 제품, 도메인 경험 |
| Featured | 식수대장 서비스 소개와 아키텍처 다이어그램 |
| Career | 대표 경력 타임라인과 기타 경력 토글 |
| Projects | 앱, 거래소, AI 프로젝트 카드 |
| AI Capability | RAG, 파인튜닝, Judge LLM 등 AI 실무 역량 |
| Contact | 이메일, GitHub, Velog 링크 |
